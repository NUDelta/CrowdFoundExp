//
//  AddLocationBViewController.m
//  CrowdFound
//
//  Created by Yongsung on 3/8/15.
...
@interface AddLocationBViewController () <MKMapViewDelegate, CLLocationManagerDelegate>

@property (weak, nonatomic) IBOutlet MKMapView *mapView;
@property (strong, nonatomic) CLLocationManager *locationManager;
@end

@implementation AddLocationBViewController
